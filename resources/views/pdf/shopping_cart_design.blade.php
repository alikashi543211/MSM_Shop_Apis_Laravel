                ...
                <tr>
                    ...
                    <td width="45%">
                        ...
                        <div class="address_box">
                            Ethelbright Parthinghew,<br>
                            125 Hollow Tree Lane,<br>
                            Apartment 500,<br>
                            Southampton, Bermuda SH06
                        </div>
                    </td>
                    <td width="45%">
                        <span class="address_title delivery_inst_title"></span><br>
                        {{-- <div class="delivery_inst_box">
                            Go up the hilll and past the tree.<br>
                            Go left and drive through the arched hedge.<br>
                            Go through the pig farm and past the huge yam felds.<br>
                            Next right. House is pink with no blinds.<br>
                        </div> --}}
                                    ...
                                    {{-- Line items Section --}}
                                        <tr class="items_tr" width="100%">
                                            <td class="items_td" width="90%">
                                                Apple AirTag Polyurethane Loop - White
                                            </td>
            ...
            <tbody>
                <tr>
                    ...
                    <td width="90%" class="bank_card_box">
                        Charged to American Express xxxx 4400
